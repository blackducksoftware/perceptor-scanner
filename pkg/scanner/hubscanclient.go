...
func NewHubScanClient(host string, username string, password string, port int, javaMaxHeapSizeMBs int, scanClientInfo *scanClientInfo, imagePuller ImagePullerInterface) (*HubScanClient, error) {
	hsc := HubScanClient{
		host:               host,
		username:           username,
		password:           password,
